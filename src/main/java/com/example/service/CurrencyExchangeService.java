...
public class CurrencyExchangeService {
    ...
    public CurrencyExchangeService(RestTemplate restTemplate, @Value("${exchange.api.key}") String apiKey) {
        this.restTemplate = restTemplate;
        this.apiKey = apiKey;
    }

    public double calculateFinalAmount(BillRequest billRequest) {
        double exchangeRate = getExchangeRate(billRequest.getOriginalCurrency(), billRequest.getTargetCurrency());
